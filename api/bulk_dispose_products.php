<?php
// ============================================================
//  bulk_dispose_products.php — Mark Multiple Products as Disposed
// ============================================================
...
$stmt = mysqli_prepare($conn, "UPDATE products SET quantity = 0 WHERE id IN ($placeholders)");
mysqli_stmt_bind_param($stmt, $types, ...$ids);
mysqli_stmt_execute($stmt);
$updated = mysqli_stmt_affected_rows($stmt);
mysqli_stmt_close($stmt);

api_respond(['updated' => $updated]);
