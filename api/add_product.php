<?php
// ============================================================
//  add_product.php — Create a New Product
// ============================================================
...
$stmt = mysqli_prepare($conn, "
    INSERT INTO products (name, category_id, quantity, price, production_date, expiry_date, supplier, notes)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
");
mysqli_stmt_bind_param($stmt, 'siidssss',
    $name, $cat_int, $qty_int, $price_flt,
    $production_date, $expiry_date, $supplier_val, $notes_val
);
